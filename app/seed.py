...
def seed_demo_data(db: Session) -> None:
    ...
    db.add_all([
        Player(name="Jordan Brooks", grad_year=2026, primary_position="SS", secondary_position="OF", gpa=3.8, sat_act="SAT 1260", height="5'7\"", weight="140", throwing_hand="R", batting_side="R", home_to_first="2.90", exit_velo="68 mph", pop_time="", pitching_velo="", highlight_link="https://video.example/jordan", transcript_path="demo/transcript-jordan.pdf", photo_path="demo/jordan.jpg", social_handles="@jordanbrooks", notes="High academic performer and versatile defender."),
        Player(name="Casey Nguyen", grad_year=2027, primary_position="P", secondary_position="1B", gpa=3.6, sat_act="", height="5'9\"", weight="155", throwing_hand="R", batting_side="L", home_to_first="3.15", exit_velo="63 mph", pop_time="", pitching_velo="61 mph", highlight_link="https://video.example/casey", transcript_path="", photo_path="demo/casey.jpg", social_handles="@caseynguyen", notes="Command-focused right-handed pitcher.")])
